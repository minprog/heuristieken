...
9. De wijk bestaat voor een deel uit oppervlaktewater. Huizen mogen niet op het water worden geplaatsd, maar hun vrijstand mag daar wel op vallen (zowel de verplichte als die voor de waarde berekening).
...
Bekijk [het voorbeeld](example_output.csv) (3 huizen op wijk_1 geplaatsd) en zorg ervoor dat jouw programma een oplossing in hetzelfde format kan omzetten.
